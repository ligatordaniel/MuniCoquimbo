...
; (function ($, window, document, undefined) {
    ...
    var function_keys = {
        ...
        numeric_mail: {
            text: '?123',
            command: function () {
                this.createKeyboard('numericMail');
                this.events();
            }
        },
        layout_switch: {
        ...
        character_switch: {
            text: 'abc',
            command: function () {
                this.createKeyboard('tradicional');
                this.events();
            }
        },
        character_switch2: {
            text: 'abc',
            command: function () {
                this.createKeyboard('custom_mail');
                this.events();
            }
        },
        symbol_switch: {
    ...
    var layouts = {
        selectable: ['azeri', 'custom', 'english', 'russian'],
        azeri: [
        ...
        custom_mail: [
            ['q', 'w', 'e', 'r', 't', 'y', 'u', 'i', 'o', 'p',],
            ['a', 's', 'd', 'f', 'g', 'h', 'j', 'k', 'l',],
            ['numeric_mail', 'z', 'x', 'c', 'v', 'b', 'n', 'm', 'backspace'],
            ['.com', '@', 'space', 'return']
        ],        
        english: [
            ['q', 'w', 'e', 'r', 't', 'y', 'u', 'i', 'o', 'p',],
        ...
        numericMail: [
            ...
            ['5', '6', '7', '8', '9'],
            ['.','-', '_', '@', 'backspace'],
            ['character_switch2', 'space', 'return'],
        ],
        numbers_only: [
            ['1', '2', '3',],
            ['4', '5', '6',],
    ...
    Plugin.prototype = {
        ...
        events: function () {
            ...
            return_key.on('click', function () {
                ...
                $("#keyboard2").slideUp("slow");
                $("#keyboard3").slideUp("slow");
                me.type("");
        ...
        backspace: function () {
          var selStart = this.settings.input[0].selectionStart;
          var selEnd = this.settings.input[0].selectionEnd;

          var textAreaStr = this.settings.input.val();
          var after = textAreaStr.substring(0, selStart-1);
          var value = after + textAreaStr.substring(selEnd);
          this.settings.input.val(value).focus();
          this.settings.input[0].selectionStart = selStart-1, this.settings.input[0].selectionEnd = selStart-1;
        },
